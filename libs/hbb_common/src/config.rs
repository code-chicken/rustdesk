...
pub const RENDEZVOUS_SERVERS: &[&str] = &["help.itservices-hahn.de", "hilfe.itservices-hahn.de"];
pub const PUBLIC_RS_PUB_KEY: &str = "umXteiQZtSByyVlQcXVCc91A57D4bMVejKd6KJYZiJA=";
